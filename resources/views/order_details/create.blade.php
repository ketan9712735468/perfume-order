                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('order_details.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="sales_order" name="sales_order" value="{{ old('sales_order') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500" required>
                            @error('sales_order')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="invoice_number" name="invoice_number" value="{{ old('invoice_number') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500" required>
